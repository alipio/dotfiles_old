...
ln -sfv "$DOTFILES_DIR/runcom/.curlrc" ~
ln -sfv "$DOTFILES_DIR/runcom/.irbrc" ~
ln -sfv "$DOTFILES_DIR/runcom/.pryrc" ~
ln -sfv "$DOTFILES_DIR/runcom/.railsrc" ~
ln -sfv "$DOTFILES_DIR/runcom/.psqlrc" ~
ln -sfv "$DOTFILES_DIR/git/.gitconfig" ~
ln -sfv "$DOTFILES_DIR/git/.gitignore_global" ~
ln -sfv "$DOTFILES_DIR/git/.git_template" ~
ln -sfv "$DOTFILES_DIR/etc/.ctags" ~
ln -sfv "$DOTFILES_DIR/etc/.agignore" ~
